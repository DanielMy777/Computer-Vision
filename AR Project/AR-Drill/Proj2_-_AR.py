...
drill_path = "./media/objs/drill/drill.obj"
...
out = cv2.VideoWriter('output-drill.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 30, (orig_frame_width,orig_frame_height))
...
# ======= Renderer
renderer = MeshRenderer(camera_k, orig_frame_width, orig_frame_height, drill_path)
...
def process_frame(frame):
    ...
    renderer.draw(result, r_vec, t_vec)
