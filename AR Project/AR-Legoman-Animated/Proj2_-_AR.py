# %% [markdown]
# # Project 2 extra extra: AR - Animated Custom 3D Model
...
from mesh_renderer_animated import AnimatedMeshRenderer
...
bf = cv2.BFMatcher()
real_box_height = 27.5      # inaccurate real world sizes, to control model size
real_box_width = 18.5

lego_path_template = "./media/objs/legoman-animated/legoman_000000"
num_animated_frames = 120
...
out = cv2.VideoWriter('output-legoman-animated.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 30, (orig_frame_width,orig_frame_height))
...
#======= Renderer - for animated models
lego_renderer = AnimatedMeshRenderer(camera_k, orig_frame_width, orig_frame_height, lego_path_template, num_animated_frames)
